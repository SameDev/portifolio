        ...
        <div v-else class="posts-grid">
          <article v-for="post in posts" :key="post.id" class="post-card">
            ...
            <div class="post-content">
              ...
              <NuxtLink :to="getPostLink(post)" class="post-title-link">
                <h2>{{ post.title }}</h2>
              </NuxtLink>
              <p class="excerpt">{{ post.excerpt }}</p>
              <div class="post-footer">
                <NuxtLink :to="getPostLink(post)" class="read-more">
                  Ler mais
...
const posts = computed(() => (data.value?.posts as unknown as BlogPost[]) || []);
