  ...
  <div class="blog-container">
    <div class="blog-content">
      ...
      <div v-else-if="error" class="error">
        ...
        <NuxtLink to="/blog" class="back-link">Voltar para o Blog</NuxtLink>
      </div>
      ...
      <article v-else-if="post" class="post-article">
        ...
        <footer class="post-footer">
          <div class="tags" v-if="post.tags && post.tags.length">
            <h3>Tags:</h3>
            <div class="tag-list">
              <NuxtLink v-for="tag in post.tags" :key="tag" :to="`/blog?tag=${tag}`" class="tag">#{{ tag }}</NuxtLink>
            </div>
          </div>
        </footer>
      </article>
...
const { data, pending, error } = await useFetch(() => `/api/blog/${slug.value}`);
